...
def cli_main():
    ...
    model_path = './model/image2shape/dynamic_c_valLoss0.13407523614090558_clipcap_RN50x4_Image2ShapeDataset_epoch80.ckpt'
    config = {
                      'clip_type' : 'RN50x4',
                      'prefix_length' : 10,
    ...
    task = task_list[0] # [image_to_shape, text_to_color] 목적에 맞는 task 이름으로 설정
